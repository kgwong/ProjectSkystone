...
std::shared_ptr<GameObject> GameObjectBuilder::buildBossClawProjectile(ComponentSystem& componentSystem, const std::string& name)
{
	return bossClawProjectileBuilder_.build(componentSystem, name);
}